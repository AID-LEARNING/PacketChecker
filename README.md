...
- PHP 8.x
- [DEVirion](https://github.com/poggit/devirion) (optional, for development)
...
3. Place the folder in your server's `plugins/` folder
...
- [pocketmine/pocketmine-mp](https://github.com/pmmp/PocketMine-MP) ^5.41
